...
class viewNotifications_client extends StatefulWidget {
  viewNotifications_client({Key? key}) : super(key: key);

  @override
  State<viewNotifications_client> createState() => _viewNotifications_clientState();
}

class _viewNotifications_clientState extends State<viewNotifications_client> {
  @override
