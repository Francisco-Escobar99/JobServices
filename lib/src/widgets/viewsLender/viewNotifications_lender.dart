...
class viewNotifications_lender extends StatefulWidget {
  viewNotifications_lender({Key? key}) : super(key: key);

  @override
  State<viewNotifications_lender> createState() => _viewNotifications_lenderState();
}

class _viewNotifications_lenderState extends State<viewNotifications_lender> {
  @override
