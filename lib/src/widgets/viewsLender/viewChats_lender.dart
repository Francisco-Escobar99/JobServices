...
class viewChats_lender extends StatefulWidget {
  const viewChats_lender({Key? key}) : super(key: key);

  @override
  State<viewChats_lender> createState() => _viewChats_lenderState();
}

// ignore: camel_case_types
class _viewChats_lenderState extends State<viewChats_lender> {
  @override
